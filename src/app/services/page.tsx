    ...
    <div className="flex flex-col gap-20">
      ...
      <div className="flex relative bg-[url('/about.jpg')] bg-cover bg-center bg-no-repeat flex-col-reverse w-full h-[200px] md:h-[600px]">
        ...
        <div className="absolute flex w-full h-full items-center px-10 md:px-20">
          <p className="text-2xl md:text-7xl text-white font-medium capitalize">
            Our Services
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
          {services.map((service, idx) => (
            <div
              ...
              className="flex flex-col px-4 py-6 items-center gap-2 border border-[#e5e5e5] rounded-xl shadow-md"
            >
              <p className="text-xl text-black font-medium">{service.title}</p>
